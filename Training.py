...
ds_train_image =  r"./pretrained/TCGA_imgs_idx5"
ds_train_label = r"./pretrained/TCGA_masks"
ds_test = data_folder


size = (IMG_SIZE, IMG_SIZE)
ds_train = map(lambda ds_train_image, ds_train_label: (tf.image.resize(ds_train_image, size), ds_train_label))
